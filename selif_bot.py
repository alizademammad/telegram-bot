...
# Session String از متغیر محیطی
SESSION_STRING = os.environ.get('SESSION_STRING', None)

# اگه Session String باشه → مستقیم وصل شو (بدون کد تأیید)
# اگه نباشه → اولین بار کد بخواد و بعد سشن رو بده
if SESSION_STRING:
...
async def main():
    ...
    # اگه Session String نباشه → سشن رو چاپ کن تا ذخیره بشه
